...
* do not fire complete callback on chunk success ([33037e3d](http://github.com/esbenp/fineuploader-client.git/commit/33037e3d))
...
* add isObject utility function ([8dbd2eba](http://github.com/esbenp/fineuploader-client.git/commit/8dbd2eba))
